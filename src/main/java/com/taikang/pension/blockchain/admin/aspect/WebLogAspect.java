package com.taikang.pension.blockchain.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.taikang.pension.blockchain.admin.base.MySysUser;
import com.taikang.pension.blockchain.admin.entity.Log;
import com.taikang.pension.blockchain.admin.exception.GlobalExceptionHandler;
...
/**
 * Created by houhx02 on 2018/1/13.
 * todo:
 */
@Aspect
@Order(5)
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.taikang.pension.blockchain.admin.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.taikang.pension.blockchain.admin.annotation.SysLog mylog = method.getAnnotation(com.taikang.pension.blockchain.admin.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
