...
/**
 * Created by houhx02 on 2018/1/25.
 * todo:定时任务配置类
 */
@Configuration
public class QuartzConfig {
    ...
    public SchedulerFactoryBean schedulerFactoryBean() throws SQLException {
        ...
        prop.put("org.quartz.scheduler.instanceName", "BlockchainScheduler");
        ...
        schedulerFactoryBean.setSchedulerName("BlockchainScheduler");
        //延时启动
